...
let
  ...
  srcDepsSet =
    let
      srcs = (builtins.fromJSON (builtins.readFile src_deps));
      ...
      (if stdenv.hostPlatform.isDarwin
       then srcs."java_tools_javac11_darwin-${javac11}.zip"
       else srcs."java_tools_javac11_linux-${javac11}.zip")
  ...
  remote_java_tools = stdenv.mkDerivation {
    ...
    src = srcDepsSet."java_tools_javac11_${system}-${javac11}.zip";
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (stdenv.lib.optional (toString javac11 == "v6.1") ./glibc2_3.patch)
